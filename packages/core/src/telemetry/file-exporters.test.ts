...
describe('FileExporter.serialize', () => {
  ...
  // A raw JSON.stringify on a ReadableSpan crashed because
  // BatchSpanProcessor._shutdownOnce -> BindOnceFuture._that forms a cycle.
  // The exporter must delegate to safeJsonStringify so cycles become
