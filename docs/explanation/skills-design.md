...
proto ships with 22 bundled skills covering common agentic workflows: `adversarial-verification`, `brainstorming`, `browser-automation`, `coding-agent-standards`, `sprint-contract`, `test-driven-development`, and more. These are always available regardless of project or user configuration.
